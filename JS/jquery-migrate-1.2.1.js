        ...
        $.xui.tabs = $.extend(tabs, {
            ...
            _create: function () {
                ...
                if (o.scrollable) {
                    ...
                    var navPrev = $('<li class="ui-tabs-arrow-previous ui-state-default ui-corner-bl ui-corner-tl" title="Previous"><a href="#"><span class="lefttab">Previous tab</span></a></li>').prependTo(arrowsNav).hide(),
                        navNext = $('<li class="ui-tabs-arrow-next ui-state-default ui-corner-tr ui-corner-br" title="Next"><a href="#"><span class="righttab">Next tab</span></a></li>').appendTo(arrowsNav).hide();
                    ...
                    self.header.bind('mousewheel', function (e) {
                        e.preventDefault();
